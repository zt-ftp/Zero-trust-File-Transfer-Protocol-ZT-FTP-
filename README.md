...
2- run the client main class (each instance refer to one user )
3-when you use the upload file ,I recomended you to put the file in the client_files then when the termenal ask you to put the name of the file you should put the real path for it (if you use my recommendations you need to put: client_files/FILE NAME...)
...
NOTE: this project was created by us for  85% - 90% of it ,but we used Google and AI models to help us in write some features
like the session key and the pattern of loging in the server side but now we know how it implement and how to use it ..... 
